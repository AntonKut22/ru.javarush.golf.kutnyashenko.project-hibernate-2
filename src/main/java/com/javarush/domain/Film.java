...
@Entity
@Table(schema = "project_hibernate_2", name = "film")
public class Film {
    ...
    @Convert(converter = YearAtribureConverter.class)
    ...
    @Column(name = "special_features", columnDefinition = "set('Trailers', 'Commentaries', " +
